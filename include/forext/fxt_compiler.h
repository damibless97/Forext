#ifndef FOREXT_COMPILER_H
#define FOREXT_COMPILER_H

#include <forext/fxt_bytecode.h>
#include <forext/fxt_environment.h>
...
struct ContractEnvironment {
  struct ContractEnvironment* enclosing;
  Token name;
  bool hasSupercontract;
};
...
class Compiler {
  ...
  ContractEnvironment* currentContractEnvironment{ nullptr };
  Token current;
  Token previous;
  ...
  std::unordered_map<TokenType, Precedence> tokenPrecedence = {
    ...
    {TokenType::TOKEN_CONTRACT, Precedence::NONE},
    ...
    {TokenType::TOKEN_IMPORT, Precedence::NONE},
    {TokenType::TOKEN_AS, Precedence::NONE},
    {TokenType::TOKEN_FROM, Precedence::NONE},
    ...
    {TokenType::TOKEN_U256, Precedence::NONE},
    {TokenType::TOKEN_INTEGER, Precedence::NONE},
